...
namespace burgerLeaders
{
    public partial class checkout : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label2.Text = DateTime.Now.ToShortDateString(); //4
            findorderid();
        ...
        public void saveaddress()
        {
            ...
            String mycon1 = "Data Source=DESKTOP-FDNKUNE\\SQLEXPRESS;Initial Catalog=burgerLeaders;Integrated Security=True";
